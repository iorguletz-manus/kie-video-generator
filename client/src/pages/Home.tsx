...
export default function Home({ currentUser, onLogout }: HomeProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 py-4 md:py-8 px-2 md:px-4">
      ...
      {/* Trimming Modal - same design as ProcessingModal */}
      <Dialog open={isTrimmingModalOpen} onOpenChange={setIsTrimmingModalOpen}>
        <DialogContent className="max-w-md" onInteractOutside={(e) => e.preventDefault()}>
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Loader2 className="w-5 h-5 animate-spin text-purple-600" />
              ✂️ Trimming Videos cu FFMPEG API
            </DialogTitle>
            <DialogDescription>
              Tăiem fiecare video la dimensiunea corectă folosind markerele setate...
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-center text-sm font-medium text-gray-700">
                {trimmingProgress.current}/{trimmingProgress.total} videouri trimmed
              </p>
            </div>
            ...
            {trimmingProgress.current < trimmingProgress.total && trimmingProgress.currentVideo && (
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                ...
                <div className="flex items-center gap-2 text-xs text-purple-700">
                  ...
                  {trimmingProgress.status === 'trimming' ? '✂️ Trimming...' : '⏳ Processing...'}
                </div>
              </div>
            )}

            {/* Estimated Time */}
            {trimmingProgress.current < trimmingProgress.total && trimmingProgress.total > 0 && (
            ...
            {trimmingProgress.status === 'complete' && (
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
                <p className="text-sm font-semibold text-green-900">
                  ✅ Toate videouri trimmed cu succes!
                </p>
