      ...
      />
        ...
        {currentStep === 6 && videoResults.length > 0 && (
          <Step6 
            ...
            step5Filter={step5Filter}
            setStep5Filter={setStep5Filter}
            step5FilteredVideos={step5FilteredVideos}
            acceptedCount={acceptedCount}
            regenerateCount={regenerateCount}
            combinations={combinations}
            modifyingVideoIndex={modifyingVideoIndex}
            setModifyingVideoIndex={setModifyingVideoIndex}
            modifyDialogueText={modifyDialogueText}
            setModifyDialogueText={setModifyDialogueText}
            modifyRedStart={modifyRedStart}
            setModifyRedStart={setModifyRedStart}
            modifyRedEnd={modifyRedEnd}
            setModifyRedEnd={setModifyRedEnd}
            modifyEditorRef={modifyEditorRef}
            regenerateMultiple={regenerateMultiple}
            setRegenerateMultiple={setRegenerateMultiple}
            regenerateVariantCount={regenerateVariantCount}
            setRegenerateVariantCount={setRegenerateVariantCount}
            regenerateVariants={regenerateVariants}
            setRegenerateVariants={setRegenerateVariants}
            editTimestamps={editTimestamps}
            setEditTimestamps={setEditTimestamps}
            currentTime={currentTime}
            generateMultipleVariantsMutation={generateMultipleVariantsMutation}
            generateBatchMutation={generateBatchMutation}
            regenerateAll={regenerateAll}
            prompts={prompts}
            setCombinations={setCombinations}
            modifyPromptText={modifyPromptText}
            setModifyPromptText={setModifyPromptText}
            modifyPromptType={modifyPromptType}
            setModifyPromptType={setModifyPromptType}
            selectedVideoIndex={selectedVideoIndex}
            setSelectedVideoIndex={setSelectedVideoIndex}
            loadSampleVideos={loadSampleVideos}
            regenerateSingleVideo={regenerateSingleVideo}
            regenerateWithModifications={regenerateWithModifications}
            goToCheckVideos={goToCheckVideos}
            images={images}
            setCurrentStep={setCurrentStep}
            setAdLines={setAdLines}
